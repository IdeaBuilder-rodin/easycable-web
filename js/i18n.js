...
WE.i18n = (function () {
  ...
  var EN = {
    ...
    // ===== 툴바 툴팁(data-tip) · aria · placeholder =====
    "선택 · 이동": "Select · Move",
    "배선 — 단자끼리 잇기": "Wire — connect terminals",
    "라벨 — 배선에 수축튜브 부착": "Label — heat-shrink tag on a wire",
    "텍스트 — 주석 추가": "Text — add a note",
    "배선 색": "Wire color",
    "선 두께 (1~15px)": "Line width (1–15px)",
    "꺾임": "Bent",
    "꺾임 — 가로·세로로만": "Bent — horizontal/vertical only",
    "직선 — 두 점을 곧장": "Straight — point to point",
    "미연결 확인": "Check unconnected",
    "미연결 확인 — 배선 안 붙은 단자 표시": "Check unconnected — mark terminals with no wire",
    "숨기기": "Hide",
    "숨기기 — 안 쓰는 단자 감추기": "Hide — conceal unused terminals",
    "끌어서 옮기기": "Drag to move",
    "작성일 — 비우면 최종 수정일이 들어갑니다": "Date — leave empty to use the last-modified date",
    "격자 보이기": "Show grid",
    "격자에 맞춰 붙이기": "Snap to grid",
    "배선을 클릭하면 이 글자가 양 끝에 붙습니다": "Click a wire to put this label on both ends",
    "다음에 붙일 라벨": "Next label",
    "번호 붙이기": "Number",
    "다음 번호를 자동으로 붙인다 (양 끝에 같은 번호)": "Auto-number the next wire (same number on both ends)",
    "끌어서 옮긴 자리와 지운 한쪽 끝을 자동 배치로 되돌림": "Reset dragged labels and hidden ends to automatic placement",
    "내 부품 검색": "Search my parts",
    "부품 추가 방법": "How to add parts",
    "프로젝트 이름": "Project name",
    "프로젝트 이름 — 눌러서 고칩니다 (저장 파일명·PDF 제목)": "Project name — click to edit (file name & PDF title)",
    "이지케이블 홈으로 (새 창)": "EasyCable home (new window)",
    "엑셀 파일(.xlsx)로 내보내기": "Export as Excel (.xlsx)",
    "결선표를 엑셀 파일(.xlsx)로 내보내기": "Export the wire list as Excel (.xlsx)",
    // ===== 용지 메뉴 =====
    "▭ 가로형": "▭ Landscape",
    "▯ 세로형": "▯ Portrait",
    "가로형": "Landscape",
    "세로형": "Portrait",
    "이 페이지의 용지 — ": "Paper for this page — ",
    " · 페이지마다 다르게 둘 수 있습니다": " · can differ per page",
    "용지를 ": "Paper set to ",
    " 로 바꿨습니다": "",
    "부품은 그대로 두고, 새 용지 밖으로 나가는 것만 가장자리로 넣었습니다. Ctrl+Z 로 되돌릴 수 있습니다.": "Parts stay where they were; only those outside the new paper were pulled to the edge. Ctrl+Z to undo.",
    // ===== 부품 우클릭 메뉴 =====
    "부품 정보…": "Part info…",
    "라이브러리에 저장…": "Save to library…",
    ...
    "공용 부품으로 게시…": "Publish as public part…",
    "구매 링크 · 단가": "Purchase link · unit price",
    "＋ 링크 추가": "＋ Add link",
    "데이터시트 주소를 붙여넣으세요 (http:// 또는 https://)": "Paste the datasheet URL (http:// or https://)",
    "http:// 또는 https:// 로 시작하는 주소만 넣을 수 있습니다.": "Only URLs starting with http:// or https:// are allowed.",
    "이 링크의 이름": "Name for this link",
    // ===== 결선표 =====
    "시작": "From",
    "연결된 배선이 없습니다.": "No wires connected.",
    "혼합": "Mixed",
    // ===== 공용 부품 창 =====
    "공용 부품": "Public parts",
    "공식 카탈로그": "Official catalog",
    "샘플 카탈로그": "Sample catalog",
    "검색": "Search",
    "검색 결과": "Results",
    "부품명, 모델명 또는 단자명 검색": "Search by part name, model, or terminal",
    "부품 분류": "Part categories",
    "선택한 부품 정보": "Selected part",
    // ===== 예제 창 (CLAUDE 2026-09-20) — 툴바 버튼·창·예제 =====
    "완성품 예제 — 배선도를 그대로 열고 따라 만들기": "Examples — open the wiring diagram and build along",
    "예제": "Examples",
    "완성품 따라 만들기": "Build along",
    "부품이나 주제로 찾기 — 예: ESP32, LCD, 게임": "Search by part or topic — e.g. ESP32, LCD, game",
    "예제 분류": "Example categories",
    "예제 목록": "Example list",
    "선택한 예제": "Selected example",
    "게임": "Games",
    "1개": "1",
    "배선도 있음": "Wiring available",
    "파이리와 작은 모험": "Charmander's Little Adventure",
    "ESP32-S3 · 원형 LCD · 버튼 1개 · 게임": "ESP32-S3 · round LCD · 1 button · game",
    "버튼 하나로 뛰고, 싸우고, 진화하는 손바닥 포켓 게임": "Jump, battle and evolve with a single button — a palm-sized pocket game",
    "타이틀": "Title",
    "점프": "Jump",
    "타이밍 공격": "Timed attack",
    "방어": "Guard",
    "진화": "Evolution",
    "도감": "Pokédex",
    "짧게 누르면 점프, 공중에서 한 번 더 누르면 2단 점프": "Tap to jump, tap again in the air to double-jump",
    "노란 구간에서 공격, 초록 구간에서 방어 — 타이밍 배틀": "Attack in the yellow zone, guard in the green — timing battles",
    "경험치를 모아 Lv.6 에서 리자드로 진화. 진행은 보드에 남아요": "Earn XP and evolve into Charmeleon at Lv.6. Progress is saved on the board",
    "필요한 부품": "Parts needed",
    "GC9A01 1.28\" 원형 LCD": "GC9A01 1.28\" round LCD",
    "마이크로 스위치": "Micro switch",
    "새 문서로 열립니다 — 지금 그리던 도면은 ☰ → 최근 작업에 그대로 있어요": "Opens as a new document — your current diagram stays under ☰ → Recent",
    "문서 열기": "Open document",
    "업로드": "Upload",
    "펌웨어를 USB 로 보드에 씁니다 — Chrome·Edge, 데이터 케이블": "Writes the firmware to the board over USB — Chrome/Edge, data cable",
    "업로드는 PC 의 Chrome·Edge 에서만 됩니다": "Upload works only in Chrome/Edge on a PC",
    "업로드는 https 주소에서만 됩니다": "Upload works only on an https address",
    "배선도를 불러오는 중…": "Loading wiring diagram…",
    // ===== 촬영용 배선 긋기 애니메이션 (설정 창, 관리자 전용) =====
    "촬영용 (관리자)": "Recording (admin)",
    "배선을 긋는 모습 보이기 — 단자를 이으면 선이 경로를 따라 그려집니다": "Show wires being drawn — the line follows its route when you connect terminals",
    "속도": "Speed",
    "느리게": "Slow",
    "보통": "Normal",
    "빠르게": "Fast",
    "예제 배선도를 불러오지 못했습니다.": "Could not load the example wiring diagram.",
    // 두 번째 예제 — 애니메이션 비디오(어른, lyric-eoreun) (CLAUDE 2026-09-20; 처음 「어른 — 낙서 리릭 비디오」였다가 고원빈이 「애니메이션 비디오」로). 분류 「영상」과 개수 2 도 여기.
    "영상": "Video",
    "2개": "2",
    "애니메이션 비디오": "Animation video",
    "ESP32-S3 · 원형 LCD · 버튼 1개 · 영상": "ESP32-S3 · round LCD · 1 button · video",
    "노래에 맞춰 손그림 졸라맨이 가사를 연기하는 4분짜리 애니메이션 비디오": "A 4-minute animation video where a hand-drawn stick figure acts out the lyrics in time with the song",
    "버튼을 누르면 3초 카운트다운 뒤 시작 — 영상 편집에서 노래와 맞추기 쉬워요": "Press the button: a 3-second countdown, then it plays — easy to sync with the song in your video editor",
    "가사 40줄이 손글씨로 뜨고, 졸라맨이 주저앉고·안아주고·토닥이는 4막 이야기": "40 lines of lyrics in handwriting, and a four-act story where the stick figure collapses, is held, and comforts someone",
    "길게 누르면 처음으로. 브라우저 시제품과 기기 화면이 픽셀까지 같아요": "Long-press to restart. The browser prototype and the device screen match pixel for pixel",
    "퇴근길 지하철": "Subway ride home",
    "금 가는 하트": "Cracking heart",
    "안아주기": "Holding",
    "웃는 사람들": "Laughing people",
    "토닥토닥": "Pat on the back",
    "웃음": "Smile",
    // 세 번째 예제 — 불멍(campfire) (CLAUDE 2026-09-22). 분류 「장식」과 개수 3 도 여기.
    "장식": "Decor",
    "3개": "3",
    "불멍": "Campfire",
    "ESP32-S3 · 원형 LCD · 버튼 1개 · 장식": "ESP32-S3 · round LCD · 1 button · decor",
    "책상 위에 켜 두는 손바닥 모닥불 — 가만두면 잔불이 되고, 누르면 장작이 들어가요": "A palm-sized campfire for your desk — left alone it burns down to embers; press to add a log",
    "짧게 누르면 장작 — 확 타오르고 불똥이 튀어요. 12분쯤 두면 숯불만 남아요": "Short press adds a log — it flares up and throws sparks. Leave it for about 12 minutes and only embers remain",
    "2초 누르면 불 색이 바뀌어요 — 장작불 · 푸른 불 · 보랏빛 불. 보드가 기억해요": "Hold for 2 seconds to change the flame color — wood fire, blue, violet. The board remembers",
    "그림은 일러스트, 불빛·불똥은 시뮬레이션. 브라우저 시제품과 기기 화면이 같아요": "The scene is an illustration; the glow and sparks are simulated. The browser prototype and the device screen match",
    "활활": "Blazing",
    "장작 넣기": "Adding a log",
    "잔불": "Embers",
    "푸른 불": "Blue flame",
    "보랏빛 불": "Violet flame",
    "내 라이브러리에 추가": "Add to my library",
    "내 라이브러리에 추가됨": "Added to my library",
    "내 라이브러리에 추가했습니다: ": "Added to my library: ",
    "배치": "Place",
    "다시 시도": "Retry",
    "추가됨": "Added",
    "더 보기 (": "Show more (",
    ...
    "0개": "0",
    "0개 선택": "0 selected",
    "조건에 맞는 공용 부품이 없습니다.": "No public parts match.",
    "검색 결과에서 부품을 선택하세요.": "Select a part from the results.",
    "상세 정보를 불러오는 중입니다.": "Loading details…",
    "부품 상세 정보를 불러오지 못했습니다.": "Could not load part details.",
    "부품 상세 정보를 불러오지 못했습니다. 다시 시도해 주세요.": "Could not load part details. Please try again.",
    "공용 부품을 검색하는 중입니다.": "Searching public parts…",
    "서버 스키마 적용 전이라 샘플 카탈로그를 표시합니다.": "Showing the sample catalog (server schema not applied yet).",
    "공용 카탈로그에 연결하지 못해 이전 검색 결과를 유지합니다.": "Could not reach the public catalog — keeping the previous results.",
    "공용 카탈로그를 불러오지 못했습니다. 인터넷 연결을 확인해 주세요.": "Could not load the public catalog. Check your internet connection.",
    "그림을 내려받지 못해 원본 주소로 연결했습니다. 인터넷 연결을 확인해 주세요.": "Could not download the image — linked to the original URL instead. Check your internet connection.",
    "부품 원본을 불러오지 못했습니다.": "Could not load the original part.",
    "부품을 가져오는 중입니다…": "Fetching the part…",
    "이름 없는 부품": "Unnamed part",
    "상세 모델명 미입력": "No detailed model name",
    "분류": "Category",
    "구매처 열기": "Open store",
    "미입력": "Not set",
    "없음": "None",
    ...
    "기타": "Other",
    "자세히": "Details",
    "※ 이지케이블은 제휴 링크를 사용하며, 구매 시 일정액의 수수료를 받습니다.": "※ EasyCable uses affiliate links and may earn a commission on purchases.",
    "구매자에게 추가 비용은 발생하지 않습니다.": "There is no extra cost to the buyer.",
    "이지케이블은 알리, 쿠팡 제휴 마케팅 프로그램에 참여하고 있습니다.": "EasyCable participates in the AliExpress and Coupang affiliate programs.",
    "부품 목록과 공용 부품의 구매 링크로 상품을 구매하시면 일정액의 수수료를 제공받으며, 서버 운영 등 서비스 유지에 사용됩니다.": "When you buy through purchase links in the BOM or public parts, we receive a small commission that goes toward server costs and keeping the service running.",
    // ===== 공용 부품 게시 창 (관리자) =====
    "공용 부품 게시": "Publish public part",
    "게시할 부품": "Part to publish",
    "부품 이름": "Part name",
    "새 부품으로 게시": "Publish as new part",
    "기존 항목 갱신": "Update existing entry",
    "— 연결을 끊고 따로 만듭니다": "— unlink and create separately",
    "이미지, 단자 좌표, 구매 정보와 데이터시트는 현재 부품의 스냅샷으로 게시됩니다.": "The image, terminal positions, purchase info, and datasheets are published as a snapshot of the current part.",
    "게시": "Publish",
    // ===== 단자 편집기 · 빠른 배치 =====
    "빠른 배치": "Quick place",
    "배치 프리셋 목록": "Placement preset list",
    " 배치됨": " placed",
    "배치 완료": "All placed",
    "프리셋 없음": "No presets",
    "기본 단자 T#": "Default terminal T#",
    "기본 단자 (T#)": "Default terminal (T#)",
    "공용 단자": "Common terminals",
    "부품 단자": "Part terminals",
    "← 이전": "← Previous",
    "이전 프리셋": "Previous preset",
    "건너뛰기": "Skip",
    "현재 프리셋을 건너뛰고 다음으로 이동": "Skip this preset and move to the next",
    "반복": "Repeat",
    "같은 프리셋을 계속 배치": "Keep placing the same preset",
    "이미지 클릭으로 단자 추가 (W)": "Click the image to add a terminal (W)",
    "드래그로 단자 다중선택 (V)": "Drag to select multiple terminals (V)",
    "이미지 배율": "Image zoom",
    // ===== 프리셋 창 =====
    "공용 단자 목록": "Common terminal list",
    "부품 단자 목록": "Part terminal list",
    "기본 단자 복원": "Restore default terminals",
    "선택 해제": "Clear selection",
    "단자 세트 이름": "Terminal set name",
    "예: VCC": "e.g. VCC",
    "고른 세트 삭제": "Delete selected set",
    "고르면 부품 단자로 불러옵니다": "Select to load as part terminals",
    "드래그해서 순서 변경 또는 현재 부품에 복사": "Drag to reorder or copy to the current part",
    "드래그해서 배치 순서 변경 또는 공용 단자에 복사": "Drag to change placement order or copy to common terminals",
    "세트 이름을 입력하세요": "Enter a set name",
    "저장할 단자가 없습니다": "No terminals to save",
    "저장 공간을 쓸 수 없습니다": "Storage is not available",
    // ===== 도움말(단축키) =====
    "단자명·부품명 이동": "Move terminal/part names",
    "Alt+드래그": "Alt+drag",
    "단자명·부품명 위치 초기화": "Reset terminal/part name position",
    "Alt+더블클릭": "Alt+double-click",
    "배선 라벨 지우기 (양 끝 모두)": "Remove wire label (both ends)",
    "배선 라벨 한쪽 끝만 감추기": "Hide wire label on one end",
    // ===== 힌트 · alert =====
    "이미 ": "Already ",
    " 입니다 — 양 끝에 같은 번호가 붙습니다. 누른 자리로 옮겼습니다.": " — both ends share the same number. Moved to where you clicked.",
    " 의 한쪽 끝만 감췄습니다 — 번호는 반대쪽 끝에 남아 있습니다.": ": hidden on this end only — the number stays on the other end.",
    " 라벨을 지웠습니다 (양 끝 모두). 한쪽만 감추려면 Shift+Delete.": " label removed (both ends). Shift+Delete hides one end only.",
    "이전 작업을 불러오지 못해 새 배선도로 시작했습니다. (☰ → 최근 작업)": "Could not restore your previous work — started a new diagram. (☰ → Recent)",
    "이 작업을 다른 탭에서 열었습니다.": "This project was opened in another tab.",
    "여기서 고친 내용은 저장되지 않습니다. 새로 연 탭에서 작업하세요.": "Changes made here will not be saved. Continue in the newly opened tab.",
    " — 새 탭에서 열었습니다.</p>": " — opened in a new tab.</p>",
    "개를 라이브러리에 넣고 배치했습니다.": " part(s) added to the library and placed.",
    "기준으로 삼을 구간이 없습니다.": "No reference segment.",
    "기준 배선에서 맞출 구간을 찾지 못했습니다. 기준 배선의 구간을 한 번 클릭한 뒤 다시 눌러 주세요.": "Could not find a segment on the reference wire to align to. Click a segment of the reference wire once, then try again.",
    "라이브러리 부품을 지금 모습으로 갱신했습니다: ": "Library part updated to the current look: ",
    "이미 배치된 부품은 그대로입니다 — 앞으로 꺼내 쓸 때부터 바뀐 모습이 나옵니다.": "Parts already placed are unchanged — the new look applies from the next time you place it.",
    "이지케이블이 다른 탭에서도 열려 있어 저장소를 갱신하지 못했습니다.": "EasyCable is open in another tab, so the storage could not be updated.",
    "다른 탭을 모두 닫고 새로고침해 주세요.": "Close the other tabs and reload.",
    ...
    "환불 정책": "Refund policy",
    "환불정책": "Refund policy",
    "부품 사진을 올리고 단자를 이으면,": "Upload part photos, connect the terminals —",
    "그게 배선도가 됩니다.": "and that's your wiring diagram.",
    "그게 배선도가 됩니다": "and that's your wiring diagram",
    "상호 아이비엑스(IBX)": "Business name: IBX",
    "대표 고원빈": "Representative: Wonbin Ko",
    "사업자등록번호 497-25-02151 (간이과세자)": "Business registration no. 497-25-02151 (simplified taxpayer)",
    "통신판매번호 제2026-영종구-0124호": "E-commerce registration no. 2026-Yeongjong-gu-0124",
    "주소 인천광역시 영종구 하늘별빛로 66 (중산동, 영종힐스테이트)": "Address: 66 Haneulbyeolbit-ro, Yeongjong-gu, Incheon, Korea (Jungsan-dong, Yeongjong Hillstate)",
    "전화 010-2864-7171": "Phone: +82-10-2864-7171",
    "이메일 easycableinfo@gmail.com": "Email: easycableinfo@gmail.com",
    "요금 안내 — 이지케이블 (EasyCable)": "Pricing — EasyCable",
    "내 계정 — 이지케이블 (EasyCable)": "My account — EasyCable",
    "결제 — 이지케이블": "Checkout — EasyCable",
    "부품 사진을 올리고 단자를 이으면 배선도가 됩니다. 아두이노·ESP32 프로젝트 배선을 실물 사진 그대로. 설치 없이 브라우저에서, 부품 목록과 PDF는 자동으로.": "Upload part photos, connect the terminals, and you have a wiring diagram. Draw Arduino/ESP32 project wiring with real photos — in the browser, no install, with an automatic parts list and PDF.",
    "이지케이블 요금 안내. 무료로 시작하고, 필요할 때만 이용권을 구매하세요. 1개월 6,900원 · 1년 46,800원(월 3,900원).": "EasyCable pricing. Start free and buy a pass only when you need it. 1 month ₩6,900 · 1 year ₩46,800 (₩3,900/month).",
    // ===== 랜딩 =====
    "회로 기호를 몰라도 됩니다. 아두이노·ESP32 프로젝트의 배선을 실물 사진 그대로 그리고, 부품 목록은 자동으로 만들어집니다.": "No circuit symbols needed. Draw your Arduino/ESP32 wiring with real part photos, and the parts list builds itself.",
    "무료로 시작하기": "Start for free",
    "재생": "Play",
    "이지케이블로 배선도를 그리는 화면": "Drawing a wiring diagram in EasyCable",
    "보드에 물린 선을, 남이 알아볼 수 있게": "Make the wires on your board readable to others",
    "사진 한 장으로는 이 선이 어느 핀에서 나왔는지 알 수 없습니다.": "A single photo can't tell you which pin a wire came from.",
    "프로젝트 배선도": "Project wiring diagram",
    "아두이노·ESP32·라즈베리파이에 센서·모터·릴레이를 어떻게 물렸는지 그립니다. 단자 위치를 사진 위에 직접 찍기 때문에 핀 번호까지 그대로 남습니다.": "Show how sensors, motors, and relays are wired to an Arduino, ESP32, or Raspberry Pi. Terminals are marked right on the photo, so even pin numbers stay exact.",
    "부품 목록": "Parts list",
    "어떤 부품을 몇 개 썼는지, 어디서 얼마에 샀는지가 표로 정리됩니다. 도면을 보고 표에 옮겨 적는 작업이 없어집니다.": "Which parts, how many, where you bought them and for how much — all in a table. No more copying from the drawing by hand.",
    "넘겨줄 수 있는 문서": "Documents you can hand over",
    "블로그·깃허브·과제 제출·팀 인수인계. PDF와 이미지로 뽑아 그대로 넘기면, 받는 사람이 같은 것을 만들 수 있습니다.": "Blog posts, GitHub, coursework, team handovers. Export to PDF or image and pass it on — the recipient can build the same thing.",
    "쓰는 순서": "How it works",
    "처음 도면 하나를 끝내는 데 오래 걸리지 않습니다.": "Your first diagram won't take long.",
    "부품을 올립니다": "Add parts",
    "사진을 끌어다 놓고 단자 위치를 찍습니다. 한 번 만든 부품은 저장해 두고 계속 씁니다.": "Drop in a photo and mark the terminals. Save a part once and reuse it forever.",
    "단자를 잇습니다": "Connect terminals",
    "단자에서 단자로 끌면 선이 됩니다. 경로는 알아서 정리된 모양으로 지나갑니다.": "Drag from terminal to terminal to make a wire. The route tidies itself.",
    "번호를 붙입니다": "Label the wires",
    "전선 번호·색·굵기(AWG)를 적어 둡니다. 수축튜브 번호를 그대로 쓰면 실물과 도면이 이어집니다.": "Note wire numbers, colors, and gauge (AWG). Use the same numbers as your heat-shrink tags and the diagram matches the real thing.",
    "내보냅니다": "Export",
    "PDF·이미지로 뽑습니다. 작업 파일은 따로 저장해 다음에 이어서 씁니다.": "Export to PDF or image. Save the project file to pick up where you left off.",
    "그리기만 하면,": "Just draw —",
    "도면과 부품 목록이 함께": "the diagram and the parts list come together",
    "따로 정리하는 시간이 없어집니다.": "No separate tidying-up afterwards.",
    "단자까지 그려진 배선도": "A wiring diagram down to the terminal",
    "어느 핀에서 어느 핀으로 이었는지가 그림만 보고 읽힙니다. 전선 번호와 색도 도면 위에 그대로 남습니다.": "Which pin connects to which is readable at a glance. Wire numbers and colors stay right on the drawing.",
    "이지케이블 배선도 — 실물 사진 부품에 단자와 배선이 그려져 있다": "EasyCable diagram — terminals and wires drawn on real part photos",
    "그대로 발주하는 부품 목록": "A parts list you can order from",
    "부품·수량·단가·구매 링크가 자동으로 모입니다. 합계까지 나오므로 따로 정리할 것이 없습니다.": "Parts, quantities, unit prices, and purchase links collect automatically — with totals, so nothing to tidy up.",
    "이지케이블 부품 목록 — 부품명·수량·단가·구매 링크와 합계": "EasyCable parts list — names, quantities, unit prices, purchase links, and totals",
    "PDF·이미지로 내보내기": "Export to PDF or image",
    "종이로 뽑아도, 태블릿으로 봐도 단자 번호가 읽히도록 만들어집니다. 작업 파일(": "Terminal numbers stay legible on paper or on a tablet. Save the project file (",
    ")로 저장해 두면 나중에 이어서 고칠 수 있습니다.": ") and you can come back and edit later.",
    "무엇이 다른가요?": "What's different?",
    "손으로 그리던 방식과 견주어 봅니다.": "Compared with drawing by hand.",
    "항목": "Item",
    "손으로 그리기": "By hand",
    "파워포인트·그림판": "PowerPoint / Paint",
    "부품 모양": "Part shapes",
    "직접 그려야 함": "Draw them yourself",
    "내가 올린 실물 사진": "Your own real photos",
    "부품 목록·단가": "Parts list & prices",
    "직접 정리": "Compile by hand",
    "자동 · 구매 링크까지": "Automatic, with purchase links",
    "고쳐 쓰기": "Editing later",
    "대개 처음부터 다시": "Usually start over",
    "언제든 고칠 수 있음": "Edit anytime",
    "설치": "Install",
    "프로그램이 필요함": "Needs a program",
    "브라우저에서 바로": "Right in the browser",
    "무료로 시작해서, 필요할 때만": "Start free, pay only when you need to",
    "구독이 아니라 이용권입니다.": "It's a pass, not a subscription.",
    "지금 바로 그려 보세요": "Try it right now",
    "가입도, 설치도 필요 없습니다.": "No sign-up, no install.",
    // ===== 요금제 =====
    "구독이 아닙니다. 산 기간만 쓰고, 끝나면 자동으로 무료로 돌아갑니다.": "Not a subscription. Use it for the period you bought; when it ends you're back on the free plan automatically.",
    "무료": "Free",
    "간단한 작업은 무료로도 이용 가능합니다.": "Simple projects can be done on the free plan.",
    "기본 제공": "Included",
    "계속 무료": "Free forever",
    "도면 하나에": "Per diagram",
    "부품 10개 · 배선 30개": "10 parts · 30 wires",
    "도면 페이지": "Diagram pages",
    "1장": "1 page",
    ...
    "BOM · 결선표 인쇄 · PDF 출력": "BOM · wire list printing · PDF export",
    "파일 저장 / 열기": "Save / open files",
    "Pro · 1개월": "Pro · 1 month",
    "/ 1개월": "/ 1 month",
    "짧은 기간에 많은 배선도 작업이 필요한 경우에 유용합니다.": "Good for a burst of diagram work over a short period.",
    "결제하기": "Buy now",
    "1개월 동안": "For 1 month",
    "부품 · 배선": "Parts · wires",
    "무제한": "Unlimited",
    ...
    "아닙니다. 구독이 아니라": "No. It's not a subscription but a",
    "이용권": "Pass",
    "이라, 산 기간만큼만 쓰고 끝나면 자동으로 무료로 돌아갑니다. 해지할 것이 없고, 카드에서 다시 빠져나가는 돈도 없습니다. 계속 쓰시려면 그때 다시 결제하시면 됩니다.": " — you use it for the period you bought, and when it ends you're back on the free plan automatically. Nothing to cancel, nothing charged to your card again. If you want to continue, just buy again then.",
    "다른 컴퓨터에서도 쓸 수 있나요?": "Can I use it on another computer?",
    "이용권은": "Your pass",
    "계정을 따라가므로, 로그인하시면 어느 컴퓨터에서든 그대로 적용됩니다.": "follows your account, so it applies on any computer once you sign in.",
    "도면은": "Your diagrams",
    "쓰시던 브라우저에 저장되기 때문에 자동으로 옮겨지지 않습니다. 옮기시려면 도면을 파일(": "are stored in the browser you used, so they don't move on their own. To move one, export it as a file (",
    ")로 내보낸 뒤 다른 컴퓨터에서 열면 됩니다. 부품과 사진까지 한 덩어리로 들어가므로 그대로 이어서 작업하실 수 있습니다.": ") and open it on the other computer. Parts and photos travel inside the file, so you can pick up right where you left off.",
    "배선도면이 노출되지 않나요?": "Could my diagrams be exposed?",
    "저희 서버로 올라가지 않습니다.": "They never go to our server.",
    "그릴 때도, 저장할 때도 여러분 브라우저 안에서만 처리됩니다. 그래서 저희도 여러분의 도면을 볼 수 없습니다.": "Drawing and saving happen entirely inside your browser — so even we can't see your diagrams.",
    "도면이 밖으로 나가는 것은": "A diagram leaves your computer",
    "직접 파일이나 PDF로 내보내 전달하실 때뿐": "only when you export it as a file or PDF and share it yourself",
    // 2026-09-23 삭제 — "올리신 부품 사진도 마찬가지로 브라우저에만 남습니다." 는 거짓이 됐다.
    // library-sync 가 라이브러리 부품의 사진을 서버로 받고 있다(privacy.html 제2조). 문장을 뺐다.
    "데이터는 어디에 저장되나요?": "Where is my data stored?",
    // 2026-09-23 문구 교체 — 옛 문장은 "도면·부품·사진은 모두 브라우저 안 / 서버에 있는 것은 계정·결제뿐" 이었다.
    // library-sync(2026-09-14~)가 라이브러리 부품과 이미지를 서버로 받고 있어 사실과 달랐다. 도면만 말한다.
    "도면은 쓰시는 브라우저 안": "Your diagrams live inside your browser",
    "에 저장되고, 저희 서버로 보내지 않습니다.": " — we never send them to our server.",
    "입니다.": ".",
    "그래서 브라우저 데이터를 지우거나 다른 기기로 옮기면 따라오지 않으니, 중요한 도면은": "That means they won't follow you if you clear browser data or switch devices, so for important diagrams",
    "파일(": "export a file (",
    ")로 내보내": ") and",
    ...
    "전자상거래법에 따라 5년간 보관합니다.": "Kept for 5 years as required by the Korean E-Commerce Act.",
    "남아 있는 이용권 — 잔여 기간이 소멸합니다": "Remaining pass — the remaining period will be forfeited",
    "결제·환불 기록 — 전자상거래법에 따라 5년간 보관됩니다": "Payment and refund records — kept for 5 years as required by the Korean E-Commerce Act",
    "남아 있는 이용권이 있습니다.": "You still have an active pass.",
    "탈퇴하면 잔여 기간이 소멸합니다.": "Deleting your account forfeits the remaining period.",
    "환불을 원하시면": "If you want a refund,",
    "탈퇴하기 전에": "before deleting your account",
    "고객센터(": "contact support (",
    ")로 신청해 주세요. 환불 기준은": "). Refunds follow",
    "이용약관 제8조": "Article 8 of the Terms of Service",
    "를 따릅니다.": ".",
    // ===== 결제 =====
    "← 요금제로 돌아가기": "← Back to pricing",
    "이용권을 선택해 주세요.": "Please choose a pass.",
    "결제": "Checkout",
    "주문 내용": "Order summary",
    "상품": "Item",
    "결제 금액": "Amount",
    "이미 이용 중입니다": "You already have an active pass",
    "1년 이용권으로 바꾸시겠어요?": "Switch to the 1-year pass?",
    "지금 이용 기간은 그대로 두고": "Your current period stays as is, and",
    "12개월이 더해집니다.": "12 months are added on top.",
    "환불하고 다시 결제하실 필요가 없습니다.": "No need to refund and buy again.",
    "1년 이용권 · ₩46,800": "1-year pass · ₩46,800",
    "이용 기간이 끝난 뒤에 다시 결제하실 수 있습니다.": "You can buy again after your current period ends.",
    "결제가 완료되었습니다": "Payment complete",
    "내 계정에서 확인": "View in my account",
    // ===== 2026-09-15 영어판 1단계 — 9/14 검토(_ai/검토_영어판_2026-09-14.md)에서 빠진 것. 새 문구는 tests/verify_i18n 이 잡는다 =====
    // ===== 요금제 (인라인 JS) =====
    "현재 이용 중": "Current plan",
    "이용 중에는 구매할 수 없습니다": "Not available while a pass is active",
    "1년 이용권으로 변경": "Switch to the 1-year pass",
    // ===== 내 계정 (인라인 JS) =====
    "구글": "Google",
    "카카오": "Kakao",
    "네이버": "Naver",
    "기간 제한 없음": "No expiry",
    "결제 완료": "Paid",
    "일부 환불": "Partially refunded",
    "환불": "Refunded",
    "실패": "Failed",
    "진행 중": "Pending",
    "1개월 이용권": "1-month pass",
    "1년 이용권": "1-year pass",
    "결제 내역이 없습니다.": "No payments yet.",
    " (환불 ": " (refunded ",
    "영수증": "Receipt",
    "✦ 이용 중": "✦ Active",
    "기본": "Basic",
    "배선 개수 제한 없이 사용하실 수 있습니다.": "No limit on the number of wires.",
    "무료 요금제는 도면 하나에 배선 30개까지 사용하실 수 있습니다.": "The free plan allows up to 30 wires per diagram.",
    // ===== 결제 (인라인 JS) =====
    "이지케이블 1개월 이용권": "EasyCable 1-month pass",
    "1개월": "1 month",
    "이지케이블 1년 이용권": "EasyCable 1-year pass",
    "12개월": "12 months",
    ...
    "<b>결제가 취소되었습니다</b>": "<b>Payment canceled</b>",
    "<p style=\"margin-top:10px\"><a href=\"pricing.html\">다시 시도하기</a></p>": "<p style=\"margin-top:10px\"><a href=\"pricing.html\">Try again</a></p>",
    "<p style=\"margin-top:10px\">코드: ": "<p style=\"margin-top:10px\">Code: ",
    " · 계속 실패하면 <a href=\"mailto:easycableinfo@gmail.com\">고객센터</a>로 알려 주세요.</p>": " · If it keeps failing, <a href=\"mailto:easycableinfo@gmail.com\">contact support</a>.</p>",
    "결제를 확인하고 있습니다. <b>이 창을 닫지 마세요.</b>": "Confirming your payment. <b>Please don't close this window.</b>",
    "<b>결제는 진행되었으나 로그인이 풀렸습니다.</b>": "<b>The payment went through, but you were signed out.</b>",
    "<p style='margin-top:8px'>다시 로그인하시면 이용권이 자동으로 적용됩니다. ": "<p style='margin-top:8px'>Sign in again and your pass will be applied automatically. ",
    "적용되지 않으면 주문번호 <code>": "If it isn't, send order no. <code>",
    "</code> 를 <a href='mailto:easycableinfo@gmail.com'>고객센터</a>로 알려 주세요.</p>": "</code> to <a href='mailto:easycableinfo@gmail.com'>support</a>.</p>",
    "결제 확인에 실패했습니다": "Could not confirm the payment",
    "<p style='margin-top:10px'>주문번호 <code>": "<p style='margin-top:10px'>Order no. <code>",
    "<b>결제를 확인하고 있습니다.</b>": "<b>Confirming your payment.</b>",
    "<p style='margin-top:8px'>승인은 끝났고 마무리 중입니다. ": "<p style='margin-top:8px'>The charge is approved and we're finishing up. ",
    "<b>다시 결제하지 마세요.</b> 잠시 후 자동으로 적용됩니다.</p>": "<b>Please don't pay again.</b> It will be applied automatically in a moment.</p>",
    "<p style='margin-top:8px'>주문번호 <code>": "<p style='margin-top:8px'>Order no. <code>",
    "<p style='margin-top:10px'>확인이 길어지고 있습니다. ": "<p style='margin-top:10px'>This is taking longer than usual. ",
    "<a href='account.html'>내 계정</a>에서 잠시 후 확인해 주세요. ": "Please check <a href='account.html'>My account</a> in a moment. ",
    "그래도 안 되면 위 주문번호로 <a href='mailto:easycableinfo@gmail.com'>고객센터</a>에 알려 주세요.</p>": "If it still isn't applied, send the order number above to <a href='mailto:easycableinfo@gmail.com'>support</a>.</p>",
    "서버가 확인 결과를 주지 않았습니다.": "The server did not return a confirmation.",
    "확인 중": "Checking",
    "<b>결제 확인 중 오류가 났습니다.</b>": "<b>Something went wrong while confirming the payment.</b>",
    "<p style='margin-top:8px'>돈이 빠져나갔다면 주문번호 <code>": "<p style='margin-top:8px'>If you were charged, send order no. <code>",
    "</code> 를 ": "</code> to ",
    "<a href='mailto:easycableinfo@gmail.com'>고객센터</a>로 알려 주세요. 즉시 처리해 드립니다.</p>": "<a href='mailto:easycableinfo@gmail.com'>support</a>. We'll sort it out right away.</p>",
    "<b>이용권을 선택해 주세요.</b>": "<b>Please choose a pass.</b>",
    "<p style='margin-top:8px'><a href='pricing.html'>요금제 보기</a></p>": "<p style='margin-top:8px'><a href='pricing.html'>See pricing</a></p>",
    "결제 정보를 준비하는 중…": "Preparing checkout…",
    "<b>로그인이 필요합니다.</b>": "<b>Please sign in.</b>",
    "<p style='margin-top:8px'>이용권은 계정에 부여되기 때문에 로그인 후 결제하실 수 있습니다.</p>": "<p style='margin-top:8px'>Passes are tied to your account, so you need to sign in before paying.</p>",
    "'>로그인하러 가기</a></p>": "'>Go to sign in</a></p>",
    "결제를 시작하지 못했습니다": "Could not start the payment",
    "서버가 주문번호를 주지 않았습니다.": "The server did not return an order number.",
    "<b>결제를 시작하지 못했습니다.</b>": "<b>Could not start the payment.</b>",
    "<p style='margin-top:8px'>잠시 후 다시 시도해 주세요.</p>": "<p style='margin-top:8px'>Please try again in a moment.</p>",
    "<b>결제 모듈을 불러오지 못했습니다.</b>": "<b>Could not load the payment module.</b>",
    "<p style='margin-top:8px'>광고 차단 확장이 켜져 있다면 꺼 주세요.</p>": "<p style='margin-top:8px'>If an ad blocker is on, please turn it off.</p>",
    "<b>결제 설정이 완료되지 않았습니다.</b>": "<b>Payment setup is not complete.</b>",
    "<p style='margin-top:8px'><a href='mailto:easycableinfo@gmail.com'>고객센터</a>로 알려 주세요.</p>": "<p style='margin-top:8px'>Please <a href='mailto:easycableinfo@gmail.com'>contact support</a>.</p>",
    "결제창을 여는 중…": "Opening the payment window…",
    "{끝} 까지 이용하실 수 있습니다": "Valid until {끝}",
    "{끝} 까지": "Until {끝}",
    "{시작} 부터 {끝} 까지": "{시작} to {끝}",
    "{날짜} 까지": "Until {날짜}",
    // ===== 2026-09-15 영어판 1단계 — 9/14 검토(_ai/검토_영어판_2026-09-14.md)에서 빠진 것. 새 문구는 tests/verify_i18n 이 잡는다 =====
    // ===== 결제 — KG이니시스 휴대폰 번호 칸 (2026-09-15) =====
    "휴대폰 번호": "Mobile number",
    "결제창에만 전달되며 저장하지 않습니다.": "Passed to the payment window only — never stored.",
    "휴대폰 번호를 확인해 주세요 (예: 010-1234-5678)": "Please check the mobile number (e.g. 010-1234-5678)",
    // ===== 2026-09-15 영어판 1단계 — 9/14 검토(_ai/검토_영어판_2026-09-14.md)에서 빠진 것. 새 문구는 tests/verify_i18n 이 잡는다 =====
    "휴대폰 번호 (선택)": "Mobile number (optional)",
    "결제사가 요구할 때만 쓰이며 저장하지 않습니다.": "Used only if the payment provider requires it — never stored.",
    "이 결제사는 휴대폰 번호가 필요합니다. 입력 후 다시 눌러 주세요.": "This payment provider requires a mobile number. Please enter it and try again.",
    // ===== 2026-09-15 영어판 1단계 — 9/14 검토(_ai/검토_영어판_2026-09-14.md)에서 빠진 것. 새 문구는 tests/verify_i18n 이 잡는다 =====
    // ===== 결제 — 구매자 정보 묶음 (2026-09-15) =====
    "구매자 정보": "Buyer information",
  ...
  function detect() {
    ...
    if (q === "ko" || (q && MAPS[q])) { try { localStorage.setItem("we_lang", q); } catch (e) { /* 무시 */ } return q; }
    var saved = null;
    ...
    if (def === "ko" || (def && MAPS[def])) return def;
  ...
  function boot() {
    ...
    if (_lang !== "ko") {
      ...
      if (md && MAPS[_lang][descKey]) md.setAttribute("content", MAPS[_lang][descKey]);
