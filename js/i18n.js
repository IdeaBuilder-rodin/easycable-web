...
WE.i18n = (function () {
  ...
  var EN = {
    ...
    "입니다. 올리신 부품 사진도 마찬가지로 브라우저에만 남습니다.": ". The part photos you upload stay in your browser too.",
    "데이터는 어디에 저장되나요?": "Where is my data stored?",
    "도면·부품·사진은 모두": "Diagrams, parts, and photos are all stored",
    "쓰시는 브라우저 안": "inside your browser",
    "에 저장됩니다. 저희 서버에 있는 것은": ". All our server holds is",
    "계정 정보와 결제 기록뿐": "your account details and payment records",
    "입니다.": ".",
    "다만 그래서 브라우저 데이터를 지우시거나 다른 기기로 옮기시면 도면이 따라오지 않습니다. 중요한 도면은": "That also means diagrams won't follow you if you clear browser data or switch devices. For important diagrams,",
    "파일(": "export a file (",
    ")로 내보내 따로 보관": ") and keep a copy",
    "해 두시길 권합니다.": " somewhere safe.",
