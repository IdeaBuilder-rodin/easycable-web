...
WE.i18n = (function () {
  ...
  var EN = {
    ...
    /* ⚠ 예전 열쇠는 "⤓ 내보내기" · "⤒ 불러오기" 였다. 글리프를 SVG 아이콘으로 바꾸면서
       버튼의 글자 마디가 "내보내기" · "불러오기" 만 남아 열쇠가 안 맞게 됐다. (2026-09-10)
       "내보내기" 는 이 사전 위쪽에 이미 있고, "불러오기" 는 여기에 새로 둔다. */
    ".ezclib 라이브러리 파일을 불러와 내 라이브러리에 추가합니다": "Import an .ezclib library file into your library",
    "불러오기": "Import",
    /* 라이브러리 상단 버튼. 「내 부품 추가」에서 「부품 추가」로 줄였다(2026-09-10).
       ⚠ 옛 문구에는 열쇠가 아예 없어서 영어 화면에도 한국어가 그대로 나왔다. 이참에 넣는다. */
    "부품 추가": "Add part",
    "작성일": "Date",
    ...
    "한 번 더 누르면 도로 보입니다. Ctrl+Z 로도 되돌아갑니다.": "Press again to bring them back. Ctrl+Z also undoes this.",
    "표시된 미연결 없음 · 숨긴 단자 ": "No unconnected shown · ",
    "개가 아직 안 이어졌습니다": " hidden terminals are still unconnected",
    "숨긴 단자는 도면에 안 보이지만 배선은 붙어 있지 않습니다. 단자 배치에서 다시 켜면 보입니다.": "Hidden terminals are not drawn, but they still have no wire. Turn them back on in the terminal editor to see them.",
    "숨길 단자가 없습니다 — 보이는 단자가 모두 이어져 있습니다": "Nothing to hide — every visible terminal is connected",
    "안 쓰는 단자 ": "Hid ",
    "개를 숨겼습니다 · 부품 ": " unused terminals across ",
    "개에서": " components",
    ...
    "「": "「",
    "」의 단자 ": "」 has ",
    "개를 부품 단자 맨 뒤에 추가합니다.\n\n불러올까요?": " terminals. They will be appended to the part terminals.\n\nLoad them?",
    "불러오지 않았습니다. 지우려면 옆의 × 를 누르세요.": "Not loaded. Press × to delete this set.",
    "부품 단자에 추가: ": "Added to part terminals: ",
    "클릭: 부품 단자에 추가 · 드래그: 순서 변경": "Click: add to part terminals · Drag: reorder",
    "이름·색상 수정": "Edit name & color",
    "이 부품 단자 목록을 이름 붙여 저장합니다": "Save this part terminal list under a name",
    "공용 단자를 추가했습니다: ": "Common terminal added: ",
    "세트 이름을 입력하세요.": "Enter a set name.",
    "저장할 부품 단자가 없습니다.": "No part terminals to save.",
    "이미 있는 세트입니다: ": "This set already exists: ",
    "\n\n지금 목록으로 덮어쓸까요?": "\n\nOverwrite it with the current list?",
    "세트를 덮어썼습니다: ": "Set overwritten: ",
    "세트를 저장했습니다: ": "Set saved: ",
    "개)": ")",
    "불러왔습니다: ": "Loaded: ",
    "개 추가)": " added)",
    "세트를 지웁니다: ": "Delete this set: ",
    "\n\n이미 부품에 추가한 단자는 그대로 남습니다.": "\n\nTerminals already added to the part stay as they are.",
    "세트를 지웠습니다: ": "Set deleted: ",
    "관리자 페이지": "Admin",
    "구매 링크": "Buy link",
    "체크한 쪽이 BOM에 나갑니다": "the checked one goes to the BOM",
    "부품 정보에 설정한 기본값으로 되돌리기": "Reset to the part's saved values",
    "부품 기본값: ": "Part default: ",
    " → 이 배선도에서 수정됨 (↺ 로 되돌리기)": " → edited in this diagram (↺ to reset)",
    "이 배선도에서 추가된 값 (↺ 로 되돌리기)": "Added in this diagram (↺ to reset)",
    "해외": "Overseas",
    "국내": "Korea",
    "예: 알리익스프레스 https://...": "e.g. AliExpress https://...",
    "단가(원)": "Unit price (₩)",
    "예: 12000": "e.g. 12000",
    "역할": "Role",
    "부하(소비)": "Load (consumer)",
    ...
    "배치 편집": "Layout tools",
    "단자 목록": "Terminal list",
    "단자 편집 패널": "Terminal editor panels",
    "전체 0 · 사용 0": "All 0 · Active 0",
    "전체 단자 작업": "Actions for all terminals",
    "전체 사용": "Activate all",
    "전체 미사용": "Deactivate all",
    "모두 켜기": "Show all",
    "모두 끄기": "Hide all",
    "단자 검색": "Search terminals",
    "단자 사용 상태 필터": "Terminal active-state filter",
    "전체": "All",
    "사용": "Active",
    "미사용": "Inactive",
    "선택 켜기": "Show selected",
    "선택 끄기": "Hide selected",
    "배선도에서 단자 사용": "Use terminal in wiring diagram",
    "배선 연결됨": "Connected to a wire",
    "선택 단자 설정": "Selected terminal settings",
    "이름": "Name",
    "색상": "Color",
    "프리셋": "Preset",
    "선택 적용…": "Apply preset…",
    "단자 삭제": "Delete terminal",
    "선택 단자 삭제": "Delete selected terminals",
    "개 선택": " selected",
    "개 단자 삭제": " terminals · Delete",
    // 전용 색상 선택 팝오버 (js/colorpicker.js) — 팝오버는 DOMContentLoaded 이후에 만들어지므로
    // 마크업 일괄 치환이 닿지 않는다. 그래서 전부 WE.i18n.t() 로 감싸 두었다.
    "선택 단자 색상": "Selected terminal color",
    "색상 선택": "Pick a color",
    "최근 색상": "Recent",
    "아직 없음": "None yet",
    "빨강": "Red",
    ...
    "초록": "Green",
    "주황": "Orange",
    "배선이 연결된 단자는 끌 수 없습니다.": "A connected terminal cannot be hidden.",
    "연결된 단자 ": "Connected terminals kept visible: ",
    "개는 켜진 상태로 유지했습니다.": "",
    "전체 ": "All ",
    " · 사용 ": " · Active ",
    "조건에 맞는 단자가 없습니다.": "No terminals match the filter.",
    ...
    // 제목 — 어느 쪽 때문에 막혔는지로 갈린다
    "배선 한도에 도달했습니다": "Wire limit reached",
    "부품 한도에 도달했습니다": "Component limit reached",
    "무료 한도에 도달했습니다": "Free plan limit reached",

    // 현재 상태 — 상태줄과 모달 본문에 같은 문장을 쓴다
    "배선 {w}/{wmax} · 부품 {c}/{cmax}": "Wires {w}/{wmax} · Components {c}/{cmax}",
    "무료 버전은 도면 하나에 배선 {wmax}개 · 부품 {cmax}개까지 그릴 수 있습니다.": "The free plan allows up to {wmax} wires and {cmax} components per project.",
    "이 작업에는 배선 {w}개 · 부품 {c}개가 필요합니다.": "This action needs {w} wires and {c} components.",

    // 한도를 넘는 파일을 열었을 때 — 열기는 막지 않는다
    "무료 한도를 넘는 도면입니다": "This project exceeds the free plan limits",
    ...
    "도면 페이지 {n}/{max}": "Pages {n}/{max}",
    "무료 버전은 도면 하나에 페이지 {max}장까지 만들 수 있습니다.": "The free plan allows up to {max} pages per project.",

    // 파일 내보내기(CSV·엑셀)는 Pro 전용 — 화면에서 보는 것은 무료다
    "Pro 전용 기능입니다": "This is a Pro feature",
    "BOM·결선표를 CSV·엑셀 파일로 내보내는 것은 Pro 이용권이 필요합니다.": "Exporting the BOM and connection table to CSV or Excel requires a Pro plan.",
    "화면에서 보고 인쇄하는 것은 무료로 그대로 쓸 수 있습니다.": "Viewing and printing them on screen stays free.",

    // 위 checkOpened 문구에 페이지 수가 붙었다
    "이 도면에는 배선 {w}개 · 부품 {c}개 · 페이지 {s}장이 있습니다.": "This project has {w} wires, {c} components and {s} pages.",
    "무료 버전은 배선 {wmax}개 · 부품 {cmax}개 · 페이지 {smax}장까지입니다.": "The free plan allows {wmax} wires, {cmax} components and {smax} pages.",
    ...
    // ---- 로그인 모달 ----
    "이지케이블 로그인": "Sign in to EasyCable",
    "Google로 로그인": "Sign in with Google",
    "카카오로 로그인": "Sign in with Kakao",
    "네이버로 로그인": "Sign in with Naver",
    "카카오 로그인은 준비 중입니다. 지금은 Google 로그인을 이용해 주세요.": "Kakao sign-in is not ready yet. Please use Google for now.",
    "네이버 로그인은 준비 중입니다. 지금은 Google 로그인을 이용해 주세요.": "Naver sign-in is not ready yet. Please use Google for now.",
    "최근 사용": "Last used",
    "닫기": "Close",
    "이용약관": "Terms of Service",
    "개인정보처리방침": "Privacy Policy",
    // 실패 안내 (auth.js)
    "로그인을 취소했습니다.": "Sign-in was cancelled.",
    "이 환경에서는 로그인을 사용할 수 없습니다.": "Sign-in is not available in this environment.",
    "로그인 기능을 불러오지 못했습니다. 인터넷 연결을 확인하고 새로고침해 주세요.": "Could not load sign-in. Check your connection and refresh.",
    "로그인을 시작하지 못했습니다. 잠시 후 다시 시도해 주세요.": "Could not start sign-in. Please try again shortly.",
    // ---- 회원가입 · 동의 (2026-08-19) ----
    "또는 이메일로": "or with email",
    "이메일": "Email",
    "비밀번호": "Password",
    "비밀번호 (6자 이상)": "Password (6+ characters)",
    "아직 회원이 아니신가요?": "Don't have an account?",
    "이미 회원이신가요?": "Already have an account?",
    "회원가입": "Sign up",
    "가입하는 중…": "Signing up…",
    "로그인 중…": "Signing in…",
    "저장하는 중…": "Saving…",
    "서비스 이용 동의": "Consent to use the service",
    "이지케이블을 이용하려면 아래 항목에 동의해 주세요.": "Please agree to the items below to use EasyCable.",
    "모두 동의합니다": "Agree to all",
    "(선택 항목 포함)": "(including optional items)",
    "[필수]": "[Required]",
    "[선택]": "[Optional]",
    "만 14세 이상입니다": "I am 14 years of age or older",
    "이용약관 동의": "I agree to the Terms of Service",
    "개인정보 수집·이용 동의": "I agree to the collection and use of my personal information",
    "마케팅 정보 수신 동의": "I agree to receive marketing information",
    // 법정 고지 (개인정보보호법 제15조제2항) — 동의 항목 아래 표
    "수집·이용 내역": "Details",
    "수집 항목": "Items collected",
    "이용 목적": "Purpose",
    "보유 기간": "Retention period",
    "이메일 · 이름 · 비밀번호": "Email · Name · Password",
    "이메일 · 이름 · 프로필 정보 (소셜 사업자로부터 제공)": "Email · Name · Profile info (provided by the social login provider)",
    "회원 식별 · 서비스 제공 · 결제와 환불 안내": "Account identification · Service delivery · Payment and refund notices",
    "회원 탈퇴 시까지 (전자상거래법에 따라 거래기록은 5년 보관)": "Until you delete your account (transaction records kept for 5 years under Korean e-commerce law)",
    "새 기능·이벤트 안내": "News about new features and events",
    "동의를 철회하실 때까지": "Until you withdraw your consent",
    "거부 시 회원가입이 제한됩니다.": "Declining prevents you from signing up.",
    "거부 시 서비스 이용이 제한됩니다.": "Declining prevents you from using the service.",
    "동의 거부": "If you decline",
    "거부하셔도 서비스 이용에 제한 없음": "No restriction on your use of the service",
    "보기": "View",
    "동의하고 시작하기": "Agree and continue",
    "동의하지 않고 로그아웃": "Sign out without agreeing",
    ...
    "이미 존재하는 이메일입니다.": "This email is already registered.",
    "시도가 너무 잦습니다. 잠시 후 다시 시도해 주세요.": "Too many attempts. Please try again shortly.",
    "가입에 실패했습니다. 입력한 내용을 확인해 주세요.": "Sign-up failed. Please check what you entered.",
    "가입에 실패했습니다. 잠시 후 다시 시도해 주세요.": "Sign-up failed. Please try again shortly.",
    "확인 메일을 보냈습니다. 메일에 있는 링크를 누르면 가입이 끝납니다.": "We sent a confirmation email. Click the link in it to finish signing up.",
    "메일 확인이 아직 안 됐습니다. 받은 편지함을 확인해 주세요.": "Your email is not confirmed yet. Please check your inbox.",
    ...
    // ---- 메일 인증 (2026-08-19) ----
    "인증 링크를 메일로 전송했습니다": "We sent a verification link to your email",
    "이메일로 전송 받은 인증 링크를 확인해 주세요.": "Please open the verification link we sent to your email.",
    "링크는 발송 시점으로부터 24시간 동안 유효합니다.": "The link is valid for 24 hours from the time it was sent.",
    "메일을 못 받으셨나요?": "Didn't get the email?",
    "이메일 다시 보내기": "Send it again",
    "인증 완료!": "Verified!",
    "이제 모든 기능을 이용하실 수 있습니다.": "You can now use everything EasyCable offers.",
    "확인 메일을 다시 보냈습니다. 받은 편지함을 확인해 주세요.": "We sent the verification email again. Please check your inbox.",
    "메일을 너무 자주 보냈습니다. 잠시 후 다시 시도해 주세요.": "Too many emails sent. Please try again shortly.",
    "메일을 다시 보내지 못했습니다. 잠시 후 시도해 주세요.": "Could not resend the email. Please try again shortly.",
    "메일을 다시 보내지 못했습니다. 인터넷 연결을 확인해 주세요.": "Could not resend the email. Please check your internet connection.",
    "확인하는 중…": "Checking…",
    "이메일 인증이 아직 완료되지 않았습니다. 메일함을 확인해 주세요.": "Your email is not verified yet. Please check your inbox.",
    // ---- 회원 탈퇴 (2026-08-19) ----
    "계정": "Account",
    ...
    "탈퇴하면 되돌릴 수 없습니다.": "This cannot be undone.",
    "지워지는 것": "What gets deleted",
    "계정 정보 (이메일 · 이름)": "Account details (email · name)",
    "약관 동의 기록": "Consent records",
    // <b> 로 나뉘어 텍스트 노드가 둘이다 — 조각마다 키가 있어야 한다
    "남아 있는 이용권 —": "Any remaining pass —",
    "환불되지 않습니다": "no refund is given",
    "남는 것": "What stays",
    "이 브라우저에 저장된 배선도 — 탈퇴 후에도 무료로 계속 쓸 수 있습니다": "Diagrams saved in this browser — you can keep using them for free after leaving",
    "위 내용을 확인했으며 탈퇴합니다": "I understand and want to delete my account",
    "탈퇴하기": "Delete",
    "처리하는 중…": "Processing…",
    "탈퇴가 완료되었습니다": "Your account has been deleted",
    "계정이 삭제되었습니다. 이 브라우저의 배선도는 그대로 남아 있으며 계속 사용하실 수 있습니다.": "Your account is gone. The diagrams in this browser remain and you can keep using them.",
    "탈퇴 처리에 실패했습니다. 잠시 후 다시 시도해 주세요.": "Could not delete your account. Please try again shortly.",
    "탈퇴 처리에 실패했습니다. 인터넷 연결을 확인해 주세요.": "Could not delete your account. Please check your internet connection.",
    // ---- 비밀번호 찾기 (2026-08-19) ----
    "비밀번호를 잊으셨나요?": "Forgot your password?",
    "비밀번호 찾기": "Reset password",
    "가입하신 이메일 주소를 입력해 주세요.": "Enter the email address you signed up with.",
    "비밀번호를 다시 설정할 수 있는 링크를 보내드립니다.": "We'll send you a link to set a new password.",
    "재설정 링크 받기": "Send reset link",
    "로그인으로 돌아가기": "Back to sign in",
    "가입된 주소라면 재설정 링크를 보냈습니다. 메일함을 확인해 주세요.": "If that address is registered, we sent a reset link. Please check your inbox.",
    "메일을 보내지 못했습니다. 잠시 후 다시 시도해 주세요.": "Could not send the email. Please try again shortly.",
    "메일을 보내지 못했습니다. 인터넷 연결을 확인해 주세요.": "Could not send the email. Please check your internet connection.",
    "새 비밀번호 설정": "Set a new password",
    "앞으로 사용하실 비밀번호를 입력해 주세요.": "Enter the password you'll use from now on.",
    ...
    "이전과 다른 비밀번호를 입력해 주세요.": "Please choose a password different from the old one.",
    "재설정 링크가 만료되었습니다. 메일을 다시 받아 주세요.": "The reset link has expired. Please request a new one.",
    "비밀번호를 바꾸지 못했습니다. 잠시 후 다시 시도해 주세요.": "Could not change the password. Please try again shortly.",
    "비밀번호를 바꾸지 못했습니다. 인터넷 연결을 확인해 주세요.": "Could not change the password. Please check your internet connection.",
    "비밀번호를 바꿨습니다": "Password changed",
    "새 비밀번호로 로그인되어 있습니다.": "You are signed in with the new password."
  };
